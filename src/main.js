...
const themePalette = {
    'Coding Vibes': {
        ...
        '--game-bg': '#202c35',
        '--game-header-bg': '#2b2f34',
        '--game-header-border': 'rgba(126, 203, 255, 0.24)',
        '--board-bg': '#101d2a',
        '--board-shadow': 'rgba(4, 12, 22, 0.56)',
        '--score-bg': 'rgba(78, 141, 255, 0.16)',
        '--score-border': 'rgba(126, 203, 255, 0.65)',
        '--preview-bg': '#363838',
        '--preview-board-bg': '#252727',
        '--preview-accent': '#f0df58',
    ...
    Food: {
        ...
        '--game-bg': '#3a2419',
        '--game-header-bg': '#4c2c18',
        '--game-header-border': 'rgba(255, 209, 102, 0.34)',
        '--board-bg': '#4a2815',
        '--board-shadow': 'rgba(40, 16, 4, 0.58)',
        '--score-bg': 'rgba(255, 159, 67, 0.18)',
        '--score-border': 'rgba(255, 209, 102, 0.7)',
        '--preview-bg': '#4a2a19',
        '--preview-board-bg': '#2d1a10',
        '--preview-accent': '#ffd166',
    ...
    'DA Projects': {
        ...
        '--game-bg': '#163b4e',
        '--game-header-bg': '#18516a',
        '--game-header-border': 'rgba(124, 229, 183, 0.34)',
        '--board-bg': '#0d2d3e',
        '--board-shadow': 'rgba(3, 20, 32, 0.58)',
        '--score-bg': 'rgba(54, 195, 255, 0.18)',
        '--score-border': 'rgba(124, 229, 183, 0.7)',
        '--preview-bg': '#19485b',
        '--preview-board-bg': '#0d2d3e',
        '--preview-accent': '#7ce5b7',
    ...
    Gaming: {
        ...
        '--game-bg': '#294f60',
        '--game-header-bg': '#213a46',
        '--game-header-border': 'rgba(242, 16, 113, 0.5)',
        '--board-bg': '#1e3d4c',
        '--board-shadow': 'rgba(8, 24, 34, 0.6)',
        '--score-bg': 'rgba(242, 16, 113, 0.2)',
        '--score-border': 'rgba(242, 16, 113, 0.8)',
        '--preview-bg': '#213a46',
        '--preview-board-bg': '#18323f',
        '--preview-accent': '#f21071',
